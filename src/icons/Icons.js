...
const UserIcon = ({ size }) => {
  return (
    ...
    >
      <path
        d="M12 12C14.2091 12 16 10.2091 16 8C16 5.79086 14.2091 4 12 4C9.79086 4 8 5.79086 8 8C8 10.2091 9.79086 12 12 12ZM12 14C9.86332 14 8 15.8633 8 18H16C16 15.8633 14.1367 14 12 14ZM20 18V16C20 13.1634 17.8366 11 15 11H9C6.16344 11 4 13.1634 4 16V18H2V20H22V18H20Z"
        fill="currentColor"
      />
    </svg>
  );
...
const DeleteIcon = ({ size }) => {
  return (
    ...
    >
      <path
        d="M19 6H17V4H14.828L13.828 3H10.172L9.17199 4H7V6H5V8H19V6ZM7 6H5V19C5 19.5304 5.21071 20.0391 5.58579 20.4142C5.96086 20.7893 6.46957 21 7 21H17C17.5304 21 18.0391 20.7893 18.4142 20.4142C18.7893 20.0391 19 19.5304 19 19V6H7ZM8 8H16V19H8V8ZM10 10V17H12V10H10ZM14 10V17H16V10H14Z"
        fill="currentColor"
      />
    </svg>
  );
...
const songIcon = ({ size }) => {
  return (
    ...
    >
      <path
        d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM12 20C7.58 20 4 16.42 4 12C4 7.58 7.58 4 12 4C16.42 4 20 7.58 20 12C20 16.42 16.42 20 12 20ZM9.5 16C9.5 16.83 10.17 17.5 11 17.5C11.83 17.5 12.5 16.83 12.5 16V8C12.5 7.17 11.83 6.5 11 6.5C10.17 6.5 9.5 7.17 9.5 8V16ZM14.5 16C14.5 16.83 15.17 17.5 16 17.5C16.83 17.5 17.5 16.83 17.5 16V8C17.5 7.17 16.83 6.5 16 6.5C15.17 6.5 14.5 7.17 14.5 8V16Z"
        fill="currentColor"
      />
    </svg>
  );
...
const categoryIcon = ({ size }) => {
  return (
    ...
    >
      <path
        d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM12 20C7.58 20 4 16.42 4 12C4 7.58 7.58 4 12 4C16.42 4 20 7.58 20 12C20 16.42 16.42 20 12 20ZM11 7H13V9H11V7ZM11 11H13V17H11V11Z"
        fill="currentColor"
      />
    </svg>
  );
};
const goldStarIcon = ({ size }) => {
  return (
    <svg
      viewBox="0 0 24 24"
      width={size}
    ...
    >
       <polygon
        points="12 2 15.364 8.472 22 9.51 17 14.828 18.728 22 12 18.309 5.272 22 7 14.828 2 9.51 8.636 8.472"
        fill="gold"
      />
    </svg>
  );
};
const grayStarIcon = ({ size }) => {
  return (
    <svg
      viewBox="0 0 24 24"
      width={size}
